...
export const providersTranslations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "providers.form_field_transport_claude_cli": "Claude CLI",
    "providers.form_field_transport_help": "HTTP requires URL configuration, SDK requires selecting the official SDK and usually also needs Base URL configuration, Claude CLI simulates Claude Code CLI client",
    ...
    "providers.form_field_static_models_placeholder": '[{"id": "gpt-4", "display_name": "GPT-4", "context_length": 8192, "capabilities": ["chat"]}]',
  ...
  zh: {
    ...
    "providers.form_field_transport_sdk": "SDK",
    "providers.form_field_transport_claude_cli": "Claude CLI",
    "providers.form_field_transport_help": "HTTP 需要配置 URL，SDK 需要选择对应官方 SDK 并通常也需要配置 Base URL，Claude CLI 模拟 Claude Code CLI 客户端",
